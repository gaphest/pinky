...
//сжимает все изображения png и jpg
gulp.task('img', function() {
    return gulp.src('app/img/*.+(png|jpg)') // Берем все изображения из app
...
gulp.task('other-imgs', function() {
    return gulp.src('app/img/*.+(svg|gif)') // Берем все изображения из app
        .pipe(gulp.dest('dist/img')); // Выгружаем на продакшен
});
